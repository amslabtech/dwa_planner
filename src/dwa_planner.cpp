    ...
    odom_not_sub_count(0)
{
    ...
    predict_footprint_pub = local_nh.advertise<geometry_msgs::PolygonStamped>("predict_footprint", 1);
    finish_flag_pub = local_nh.advertise<std_msgs::Bool>("finish_flag", 1);
